% Rozdział 8 – Grafy
% definicja grafu, odwołanie do skryptu o indukcji
% definicje
% twierdzenie o drzewach
% dowód tw. Eulera o cyklach
% własności drzew
...
\begin{center}
    ...
    \tkzDrawPoints(v_1,v_2, v_3, v_4, v_5)
    \tkzDrawSegments[arrowMe=stealth](v_1,v_2 v_2,v_3 v_3,v_4 v_4,v_5 v_1,v_5)
    ...
    \tkzDefPoint(5,2){a_4}
    \tkzDrawPoints(a_1,a_2, a_3, a_4)
    \tkzDrawSegments[arrowMe=stealth](a_1,a_2 a_2,a_3 a_3,a_4 v_3,a_4 v_3,a_1)
    \end{tikzpicture}\\
\end{center}
\end{minipage}
