...
\]
Liczby $2^{f(3)}$ oraz $3^{f(2)}$ nie mogą być sobie równe, gdyż jedna jest parzysta, a druga nie. Stąd $f$ przyjmuję tę samą wartość dla dwóch różnych argumentów, co jest sprzeczne z~założeniami zadania.
