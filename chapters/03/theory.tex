% Rozdział 3 – zbiory i funkcje

%Pojęcia:
%- definicja bijekcji, injeckcji i surjekcji,
%– wywnioskowanie z istnienia powyższych równoliczności zbiorów,
%– jakiś przykład bajki kombinatorycznej

%No i kilka zadań, niedużo. Czytelnik ma załapać ideę robienia funkcji w %kombinatoryce.
...
% Source: Problem 2 from https://yufeizhao.com/olympiad/bijections.pdf 

\heading{Przykład 1}

\noindent
Dla pewnej liczby całkowitej $n$ jej \textit{podziałem} nazwiemy takie liczby $(a_1, ..., a_t)$, że
\begin{gather*}
    n = a_1 + a_2 + ... + a_t \\
...
% Source: Przykład 7 from https://smp.uph.edu.pl/msn/37/jaszu.pdf
